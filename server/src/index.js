...
app.use('/api/impact',       require('./routes/impact'));   // NEW: Impact Intelligence
app.use('/api/slack',        require('./routes/slack'));    // NEW: Slack alerts
app.get('/api/health', (_req, res) => res.json({ ok: true, ts: new Date(), version: '2.1.0' }));
